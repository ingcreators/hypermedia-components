...
# Ensure persistent named volumes mounted under /home/node are writable by the dev user.
...
ensure_writable_dir "${USER_HOME}/.local/share/pnpm"
ensure_writable_dir "${USER_HOME}/.cache/ms-playwright"
