...
Per-slot click caret placement (clicking a specific slot to edit it) and RTL
fine-tuning are deferred. Group separators are supported — see
[Group separators](#group-separators) above.
