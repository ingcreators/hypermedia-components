...
品番/商品名 on the first line, 数量/単価 on the second, 利益 on a third).
      ...
      <table class="hc-datagrid__table">
        <thead class="hc-datagrid__head">
          <tr>
            ...
            <th class="hc-datagrid__headcell" scope="col">品番</th>
            <th class="hc-datagrid__headcell" scope="col">商品名</th>
          </tr>
          <tr>
            <th class="hc-datagrid__headcell" scope="col">数量</th>
            <th class="hc-datagrid__headcell" scope="col">単価</th>
          </tr>
        </thead>
        <tbody class="hc-datagrid__record">
          <tr class="hc-datagrid__row">
            ...
            <td class="hc-datagrid__cell">ベターローストハム</td>
          </tr>
          <tr class="hc-datagrid__row">
            <td class="hc-datagrid__cell">12 箱</td>
        ...
        <tbody class="hc-datagrid__record">
          <tr class="hc-datagrid__row">
            ...
            <td class="hc-datagrid__cell">うまい素</td>
          </tr>
          <tr class="hc-datagrid__row">
            <td class="hc-datagrid__cell">47 箱</td>
  ...
  <div class="hc-datagrid" style="max-inline-size: 30rem;">
    <div class="hc-datagrid__scroll">
      <table class="hc-datagrid__table">
        <thead class="hc-datagrid__head">
          <tr>
            <th class="hc-datagrid__headcell" scope="col" style="width:2.5rem;"><span class="hc-sr-only">詳細</span></th>
            <th class="hc-datagrid__headcell" scope="col">分類名</th>
            <th class="hc-datagrid__headcell" scope="col">説明</th>
          </tr>
        </thead>
        <tbody class="hc-datagrid__record">
          <tr class="hc-datagrid__row">
            <td class="hc-datagrid__cell" style="text-align:center;">
              <button class="hc-datagrid__toggle" data-hc-datagrid-toggle type="button" aria-label="Beverages の詳細"></button>
            </td>
          ...
          <tr class="hc-datagrid__detail-row">
            <td class="hc-datagrid__detail" colspan="3">
              詳細パネル — ここに任意の HTML（ネストした表・フォーム・グラフなど）。
            </td>
          </tr>
        </tbody>
      </table>
  ...
  <tr class="hc-datagrid__row">
    <td class="hc-datagrid__cell">
      <button class="hc-datagrid__toggle" data-hc-datagrid-toggle
              type="button" aria-label="詳細"></button>
    </td>
    <td class="hc-datagrid__cell">Beverages</td>
    <td class="hc-datagrid__cell">Soft drinks, coffees, teas…</td>
  </tr>
