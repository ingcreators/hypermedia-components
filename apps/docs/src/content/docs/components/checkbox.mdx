...
<Demo previewClass="hc-preview--col">
  <div class="hc-field" style="max-inline-size:18rem;">
    ...
    <input class="hc-checkbox" id="boolfield-demo" name="active" type="checkbox" value="true" checked />
    <p class="hc-field__message">Deactivated accounts are hidden from search.</p>
  </div>
