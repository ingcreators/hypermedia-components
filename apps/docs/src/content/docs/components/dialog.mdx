...
```html
<button class="hc-button" data-variant="primary" id="open">Open</button>

<dialog class="hc-dialog" id="my-dialog">
  <header class="hc-dialog__header">
    <h2 class="hc-dialog__title">Confirm something</h2>
  </header>
  ...
  <footer class="hc-dialog__footer">
    <button class="hc-button" id="close">Cancel</button>
    <button class="hc-button" data-variant="primary">OK</button>
  </footer>
</dialog>
