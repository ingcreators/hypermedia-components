...
Range selection, multiple months side by side, week numbers, time selection,
and non-Gregorian calendars are deferred. Month / year dropdown navigation is
supported — see [Month / year navigation](#month--year-navigation). For a
no-JS native field, see
