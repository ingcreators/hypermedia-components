...
| `hc-shell__sidebar` | `<nav>` | Persistent navigation; full height on desktop. |
...
- **Desktop (≥ 60rem):** a CSS Grid with the sidebar spanning full height
  on the left, header / main / footer in the next column, and main
  scrolling independently of the chrome (`block-size: 100dvh`).
