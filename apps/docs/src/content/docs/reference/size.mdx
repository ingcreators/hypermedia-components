...
the colour / density axes you actually switch between:

```
hc.tokens.core.css            ← semantic + default colour/density + dark
...
extra colour axis is ~0.2 KB gzip and each density tier ~0.15 KB, so
