...
<head>
    ...
    <script type="module" src="~/assets/hc/hc.behaviors.js" asp-append-version="true"></script>
    <script type="module" src="~/assets/hc/macros/index.js" asp-append-version="true"></script>
